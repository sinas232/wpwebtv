 ...
 *
 * از inc/activation.php با هوک after_switch_theme صدا زده می‌شود.
 *
 * @return void
 */
...
function pixva_install_pages() {
	$definitions = array(
		...
		'calculator'  => array( 'محاسبه هزینه تعمیر', 'page-templates/page-calculator.php', '<p>برند، تکنولوژی، سایز و نوع خرابی را انتخاب کنید تا بازه قیمت سطح ۱۴۰۵ را ببینید. قیمت فقط سمت سرور محاسبه می‌شود. تعویض کامل پنل خارج از جدول محاسبه بوده و اغلب از ۱۰ میلیون تومان شروع می‌شود.</p>' ),
