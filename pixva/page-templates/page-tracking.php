...
?>
<main id="content">
	<?php pixva_page_hero( __( 'پیگیری آنلاین وضعیت تعمیر', 'pixva' ), __( 'کد پیگیری یا شماره همراهی که هنگام پذیرش ثبت شده را وارد کنید.', 'pixva' ) ); ?>
	<div class="pixva-container pixva-content">
		<form class="pixva-card pixva-track-form" data-pixva-track novalidate>
			...
			<div class="pixva-field">
				<label for="pixva-track-code"><?php esc_html_e( 'کد پیگیری', 'pixva' ); ?></label>
				<input type="text" id="pixva-track-code" name="code" class="pixva-latin" placeholder="PXV-2509-1234" autocomplete="off">
			</div>
			<div class="pixva-field">
				<label for="pixva-track-phone"><?php esc_html_e( 'یا شماره همراه', 'pixva' ); ?></label>
				<input type="tel" id="pixva-track-phone" name="phone" inputmode="numeric" placeholder="0912xxxxxxx" autocomplete="tel">
			</div>
