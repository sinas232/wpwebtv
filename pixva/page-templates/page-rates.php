...
<main id="content">
	...
	<div class="pixva-container pixva-content">
		<section class="pixva-card pixva-reveal">
			...
			<p class="pixva-notice pixva-notice--info"><?php esc_html_e( 'تعویض کامل پنل خارج از جدول محاسبه بوده و اغلب از ۱۰ میلیون تومان شروع می‌شود. اگر سلول سالم باشد، بندینگ جایگزین به‌صرفه‌تر است.', 'pixva' ); ?></p>
